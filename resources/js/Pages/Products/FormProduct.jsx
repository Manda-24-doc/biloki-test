...
export default function FormProduct({
    ...
    const submit = (event) => {
        ...
        if (mode === 'edit' && initialId) {
            put(route('products.update', initialId), options);
            return;
        }
        ...
        <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div className="border-b border-gray-200 px-6 py-4">
                ...
                <p className="text-sm text-gray-500">
                    {mode === 'edit'
                        ? 'Edit the selected product and save your changes.'
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-4 shadow-sm">
                            ...
                            <div className="relative mt-2">
                                <select
                                    ...
                                    className="block w-full appearance-none rounded-xl border-gray-300 bg-white px-4 py-3 pr-10 text-sm text-gray-700 shadow-sm transition focus:border-indigo-500 focus:ring-indigo-500"
                                    required
                                >
                            ...
                            <p className="mt-2 text-xs text-gray-500">
                                Sélectionnez la catégorie du produit dans le catalogue.
                            </p>

                            {data.product_category_id && (
                                <div className="mt-3 inline-flex items-center rounded-full bg-gray-900 px-3 py-1 text-xs font-medium text-white">
                                    Sélectionné :{' '}
                                    {
                                        categories?.find(
                                            (category) =>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            value={data.stocks}
                            onChange={(event) =>
                                setData('stocks', event.target.value)
                            }
                            required
                        />
                        <InputError className="mt-2" message={errors.stocks} />
                    </div>
                </div>
